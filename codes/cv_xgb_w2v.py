...
clf = XGBClassifier()
scores = cross_val_score(clf, X_train_w2v_IE, y_train_w2v_IE, cv=5)
print("IE Mean Accuracy: ", max(scores))

clf = XGBClassifier()
scores = cross_val_score(clf, X_train_w2v_NS, y_train_w2v_NS, cv=5)
print("NS Mean Accuracy: ", max(scores))

clf = XGBClassifier()
scores = cross_val_score(clf, X_train_w2v_TF, y_train_w2v_TF, cv=5)
print("TF Mean Accuracy: ", max(scores))

clf = XGBClassifier()
scores = cross_val_score(clf, X_train_w2v_JP, y_train_w2v_JP, cv=5)
